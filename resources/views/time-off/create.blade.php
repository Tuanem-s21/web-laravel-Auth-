  ...
  <main class="  mt-1 border-radius-lg ">
    <div class="container-fluid py-4">
      <div class=" collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-between" id="navbar">
        <h1>create time off</h1>
            <div class="d-flex">
            {{-- add --}}
            <div class="nav-item ">
              <a class="btn btn-primary active mb-0 text-white {{ (Request::is('time-off/create') ? 'active' : '') }} " href="{{ url('time-off/create') }}" target="_blank" role="button" aria-pressed="true">
                  Add
              </a>
            </div>
            {{-- search --}}
