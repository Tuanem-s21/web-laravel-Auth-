...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/logo-micae.png" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">MICAE</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0">
  <div class="collapse navbar-collapse " style="height: 120vh" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('booking/index') ? 'active' : '') }}" href="{{ url('booking/index') }}">
          {{-- icon management --}}
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('client/index') ? 'active' : '') }} " href="{{ url('client/index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              {{-- icon user --}}
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('category/index') ? 'active' : '') }}" href="{{ url('category/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- icon billing --}}
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('service/index') ? 'active' : '') }}" href="{{ url('service/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- icon reality --}}
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('staff/index') ? 'active' : '') }}" href="{{ url('staff/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- icon RTL --}}
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('voucher/index') ? 'active' : '') }}" href="{{ url('voucher/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- icon table --}}
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('time-off/index') ? 'active' : '') }}" href="{{ url('time-off/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            {{-- icon RTL --}}
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
          ...
          <span class="nav-link-text ms-1">Time Off of Staff</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('profile/index') ? 'active' : '') }}" href="{{ url('profile/index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
             {{-- icon profile --}}
            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>customer-support</title>
